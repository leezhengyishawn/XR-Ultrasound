...
#region Custom De/Serializer Methods
        ...
        public static readonly byte[] memColor = new byte[SizeCol];

        private static short SerializeColor(StreamBuffer outStream, object customobject)
        {
            Color o = (Color)customobject;
            ...
            lock (memColor)
            {
                ...
                outStream.Write(bytes, 0, SizeCol);
            }
        ...
        private static object DeserializeColor(StreamBuffer inStream, short length)
        {
            ...
            lock (memColor)
            {
                inStream.Read(memColor, 0, SizeCol);
                int index = 0;
                Protocol.Deserialize(out o.r, memColor, ref index);
                Protocol.Deserialize(out o.g, memColor, ref index);
                Protocol.Deserialize(out o.b, memColor, ref index);
                Protocol.Deserialize(out o.a, memColor, ref index);
            }
