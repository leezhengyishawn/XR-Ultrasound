...
namespace ADI.XR
{
    public class BoneController : MonoBehaviour
    {
        ...
        public void ApplyBodyPose(ARHumanBody body)
        {
            ...
            {
                //Skip moving the arms
                if ((i >= (int)JointIndices.LeftShoulder1 && i <= (int)JointIndices.LeftHandThumbEnd) ||
                    (i >= (int)JointIndices.RightShoulder1 && i <= (int)JointIndices.RightHandThumbEnd))
                    continue;
