...
namespace Pixyz.Plugin4Unity.EditorWindows
{
    ...
    public class LicensingWindow : SingletonEditorWindow {
        ...
        private Pixyz.Core.Native.WebLicenseInfo licenseToProcess;

        private string _address = null;
        private int _port = 64990;
        private bool _flexLM = true;
        ...
        private void OnEnable() {
            ...
            if (String.IsNullOrEmpty(_address) || _address == "127.0.0.1") {
                ...
                _flexLM = (Configuration.CurrentLicenseServer != null) ? Configuration.CurrentLicenseServer.useFlexLM : true;
            }
        ...
        private void OnGUI() {
            ...
            string[] titles = { "Current License", "Online", "Offline", "License Server" };
        ...
        private void drawOnline() {
            ...
            var currentLicense = Pixyz.Core.Native.NativeInterface.GetCurrentLicenseInfos();
            ...
            for (int r = 0; r < licenses.Length; r++) {
                ...
                Pixyz.Core.Native.WebLicenseInfo license = licenses[r];
