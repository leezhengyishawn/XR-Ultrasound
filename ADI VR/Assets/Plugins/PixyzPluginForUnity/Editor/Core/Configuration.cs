...
namespace Pixyz.Plugin4Unity
{
    ...
    public static class Configuration
    {
        ...
        public static string CustomVersionTag {
            get {
                if (customVersionTag == "Unset") {
                    customVersionTag = Pixyz.Core.Native.NativeInterface.GetCustomVersionTag();
        ...
        public static Compatibility IsPluginCompatible(out string message)
        {
            ...
            if (UnityVersion > 2021.2) {
                compatibility = Compatibility.UNTESTED;
                message += $"The Pixyz Plugin's compatibility has not been verified yet with Unity {UnityVersion} Share with us your feedback if you find any issue";
            }
        ...
        public static bool CheckLicense()
        {
            lastError = null;
            try {
                return Pixyz.Core.Native.NativeInterface.CheckLicense();
        ...
        public static string WebsiteURL => !String.IsNullOrEmpty(websiteLink) ? websiteLink : (websiteLink = Pixyz.Core.Native.NativeInterface.GetPixyzWebsiteURL());

        private static string docLink;
        public static string DocumentationURL => !String.IsNullOrEmpty(docLink) ? docLink : (docLink = Pixyz.Core.Native.NativeInterface.GetProductDocumentationURL());

        private static string pixyzVersion;
        public static string PixyzVersion => !String.IsNullOrEmpty(pixyzVersion) ? pixyzVersion : (pixyzVersion = Pixyz.Core.Native.NativeInterface.GetVersion());

        private static Pixyz.Core.Native.checkForUpdatesReturn? updateStatus;
        public static Pixyz.Core.Native.checkForUpdatesReturn? UpdateStatus => updateStatus;
        ...
        /// </summary>
        public static Pixyz.Core.Native.checkForUpdatesReturn CheckForUpdate()
        {
            return (Pixyz.Core.Native.checkForUpdatesReturn)(updateStatus = Pixyz.Core.Native.NativeInterface.CheckForUpdates());
        }
        ...
        private static Pixyz.Core.Native.WebLicenseInfoList licenses;
        private static Pixyz.Core.Native.LicenseInfos currentLicense = null;
        ...
        /// </summary>
        public static Pixyz.Core.Native.LicenseInfos CurrentLicense {
            get {
        ...
        /// </summary>
        public static Pixyz.Core.Native.WebLicenseInfoList Licenses {
            get {
        ...
        public static void RefreshAvailableLicenses()
        {
            ...
            try {
                lastError = null;
                licenses = Pixyz.Core.Native.NativeInterface.RetrieveWebLicenses(username, password);
            } catch (Exception exception) {
                lastError = exception.Message;
            }
        }
        ...
        public static bool ReleaseWebLicense(Pixyz.Core.Native.WebLicenseInfo license)
        {
            lastError = null;
            try {
                Pixyz.Core.Native.NativeInterface.ReleaseWebLicense(username, password, license.id);
            } catch (Exception exception) {
                lastError = exception.Message;
                return false;
            }
        ...
        public static bool RequestWebLicense(Pixyz.Core.Native.WebLicenseInfo license)
        {
            lastError = null;
            try {
                lastError = null;
                Pixyz.Core.Native.NativeInterface.RequestWebLicense(username, password, license.id);
                CurrentLicense = null;
                RetrieveTokens();
            } catch (Exception exception) {
                lastError = exception.Message;
        ...
        private static DateTime GetD(Pixyz.Core.Native.Date date)
        {
        ...
        public static bool RetrieveCurrentLicense()
        {
            lastError = null;
            try {
                if (Pixyz.Core.Native.NativeInterface.CheckLicense()) {
                    CurrentLicense = Pixyz.Core.Native.NativeInterface.GetCurrentLicenseInfos();
                } else {
                    CurrentLicense = null;
        ...
        public static bool GenerateActivationCode(string path)
        {
            ...
            if (path.Length == 0)
                return false;
            try {
                Pixyz.Core.Native.NativeInterface.GenerateActivationCode(path);
                return true;
            } catch (Exception exception) {
                lastError = exception.Message;
            }
        ...
        public static bool GenerateDeactivationCode(string path)
        {
            ...
            if (path.Length == 0)
                return false;
            try {
                Pixyz.Core.Native.NativeInterface.GenerateDeactivationCode(path);
                return true;
            } catch (Exception exception) {
                lastError = exception.Message;
            }
        ...
        public static bool InstallActivationCode(string path)
        {
            ...
            try {
                ...
                Pixyz.Core.Native.NativeInterface.InstallLicense(path);
                return true;
            } catch (Exception exception) {
                lastError = exception.Message;
            }
        ...
        public static bool IsFloatingLicense()
        {
            lastError = null;
            try {
                return Pixyz.Core.Native.NativeInterface.IsFloatingLicense();
            } catch (Exception exception) {
                lastError = exception.Message;
                return false;
            }
        ...
        public static bool ConfigureLicenseServer(string address, ushort port, bool useFlexLM) {
            ...
            try {
                lastError = null;
                tokens = null;
                Pixyz.Core.Native.NativeInterface.ConfigureLicenseServer(address, port, useFlexLM);
            } catch (Exception exception) {
                lastError = exception.Message;
                return false;
            }
        ...
        private static void RetrieveTokens()
        {
            ...
            try {
                lastError = null;
                var allTokenNames = Pixyz.Core.Native.NativeInterface.ListTokens(false);
                var allTokenPossessions = new Pixyz.Core.Native.IntList(allTokenNames.length);
                var mandatoryTokenNames = new HashSet<string>(Pixyz.Core.Native.NativeInterface.ListTokens(true).list);
                try {
                    //check tokens validity
                    for (int i = 0; i < allTokenNames.list.Length; i++)
                    {
                        allTokenPossessions[i] = Pixyz.Core.Native.NativeInterface.TokenValid(allTokenNames[i]) ? 1 : 0;
                    }
                } catch (Exception exception) {
                    lastError = exception.Message;
                }
